const vi = {
  ...
  heroImagePreview: "Xem trước ảnh hero",
  imagePreviewUnavailable: "Không xem trước được hình ảnh",
  ...
  fillReservationFields: "Vui lòng điền đầy đủ thông tin đặt bàn.",
  ...
  newReservationNotification: "Có đặt bàn mới",
  newReservationNotificationDescription: "Một khách vừa gửi yêu cầu đặt bàn.",
  guestCountShort: "khách",
  accept: "Chấp nhận",
  ...
  confirmRejectReservation: "Bạn có chắc muốn từ chối đặt bàn này?",
  ...
  description: "Mô tả",
  image: "Hình ảnh",
  aboutFieldsRequired: "Vui lòng nhập tiêu đề và mô tả phần giới thiệu.",
